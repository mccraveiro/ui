...
<InfoCard title="Do:" color="green">
  <ul>
    <li>Use cards as a container for content like settings groups, charts, status updates and modals.</li>
  </ul>
</InfoCard>
...
<InfoCard title="Don't:" color="red">
  <ul>
    <li>Nest cards within other cards. Consider Instead using horizontal rules and other means to further subdivide elements if needed.</li>
  </ul>
</InfoCard>

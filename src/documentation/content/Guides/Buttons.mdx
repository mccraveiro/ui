...
<InfoCard title="Do:" color="green">
  <ul>
    <li>Use only one primary button in a given card or section.</li>
  </ul>
</InfoCard>
...
<InfoCard title="Don't:" color="red">
  <ul>
    <li>Don't use a primary button unless there's a clear default action to take. Instead, use multiple secondary buttons.</li>
  </ul>
</InfoCard>
...
<InfoCard title="Don't:" color="red">
  <ul>
    <li>Use link buttons for navigation within the app.</li>
    <li>Use link buttons for primary or secondary actions.</li>
  </ul>
</InfoCard>
...
<InfoCard title="Do:" color="green">
  <ul>
    <li>Use split buttons to simplify 3 or more actions, including one primary action and multiple secondary actions.</li>
  </ul>
</InfoCard>
...
<InfoCard title="Don't:" color="red">
  <ul>
    <li>Use a split button when only one secondary action is available. Consider using a secondary button adjacent to a primary button instead.</li>
  </ul>
</InfoCard>
...
<InfoCard title="Do:" color="green">
  <ul>
    <li>Use the larger button size for secondary app experiences like sign in or sign up forms, onboarding flows, etc.</li>
    <li>Use the default button size for primary and secondary actions.</li>
    <li>Use the small button size for less frequently used preferences or configuration.</li>
    <li>When in doubt, use the normal (default) button size.</li>
  </ul>
</InfoCard>
...
<InfoCard title="Do:" color="green">
  <ul>
    <li>Use title case for button labels, e.g. "Add to Queue"</li>
    <li>Keep button labels short, clear and action focused.</li>
  </ul>
</InfoCard>
...
<InfoCard title="Don't:" color="red">
  <ul>
    <li>Don't use all caps for button labels, e.g. "SAVE CHANGES"</li>
    <li>Don't use all lowercase text for button labels, e.g. "save changes"</li>
    <li>Don't use ambiguous or generic text for button labels, e.g. "Submit"</li>
    <li>Use jargon or terse language, e.g. ""Re-authorize connection"</li>
  </ul>
</InfoCard>
